...
! RT: IN is changed to INOUT as it is INOUT in the cubic_spline routine
REAL(KIND=DP), DIMENSION (1:NX, 1:NZ, 0:NY+1, 4), INTENT(INOUT):: U_total_4, &
...
mu_T, mu_bar_T, mu_T_rkp1, mu_bar_T_rkp1, mutot_rkp1, &
...
F_Cranck_Exp_v1, F_Cranck_Exp_v2, F_Cranck_Exp_v3, F_Cranck_Exp_stau, F_Cranck_Exp_v2_temp
...
!!!! call a subroutine to find mu, mubar, mu_rkp1 and mubar_rkp1, mu_bar_T, and mu_bar_T_rkp1 as a &
!function of TH, THbar, THrkp1 and THbarrkp1
...
mutot_dbl_breve_rkp1(I,J,K)=((mu_rkp1(I,J,K)+mu_bar_rkp1(I,J,K))*DYF(K-1)+&
(mu_rkp1(I,J,K-1)+mu_bar_rkp1(I,J,K-1))*DYF(K))/(2*DY(K-1))
...
Cranck_Exp_stau(I,J,K)= Cranck_Exp_stau(I,J,K)+Ri*(n1*v1(I,J,K)+n2*v2(I,J,K)+n3*v3(I,J,K))

Cranck_Exp_stau(I,J,K)= Cranck_Exp_stau(I,J,K)-(2.0_DP)/Re &
*&
...
exp_spec_terms_w2_x(I,J,K) =exp_spec_terms_w2_x(I,J,K)+1.0_DP/Re*mutot_dbl_breve_rkp1(I,J,K)*&
(v1(I,J,K+1)-v1(I,J,K-1))/(2.0_DP*DY(K-1))
exp_spec_terms_w2_z(I,J,K) =exp_spec_terms_w2_z(I,J,K)+1.0_DP/Re*mutot_dbl_breve_rkp1(I,J,K)*&
(v3(I,J,K+1)-v3(I,J,K-1))/(2.0_DP*DY(K-1))
...
Exp_v2_m1 = Exp_v2
! RT: DYF added in v-boundary-conditions
CALL V_Boundary_Conditions(A,B,C,v2,NX,NY,NZ,DYF,v2_BC_Lower,v2_BC_Upper,v2_wall_Lower,v2_wall_Upper)
...
! Calculating the implicit derivatives
...
+0.25_DP*(vz_rkp1(I,J,K+1)+vz_rkp1(I,J,K))))*(0.5_DP*(v2z(I,J,K+1)+v2z(I,J,K))&
+(v3_dbl_breve(I,J,K+1)-v3_dbl_breve(I,J,K))/DYF(K) )
